...
This is a shared TypeScript library (`@actamayev/lever-labs-common-ts`) that provides core functionality for an educational robotics platform, including C++ to bytecode interpretation for ESP32-based robots.
